...
var _attemptInitTween = /* @__PURE__ */ __name(function _attemptInitTween2(tween, totalTime, force, suppressEvents) {
...
var _ticker = function() {
  var _getTime = Date.now, _lagThreshold = 500, _adjustedLag = 33, _startTime = _getTime(), _lastUpdate = _startTime, _gap = 1e3 / 240, _nextTime = _gap, _listeners = [], _id, _req, _raf, _self, _delta, _i, _tick = /* @__PURE__ */ __name(function _tick2(v) {
  ...
  _self = {
    ...
    add: /* @__PURE__ */ __name(function add(callback) {
...
var Animation = function() {
  ...
  _proto.timeScale = /* @__PURE__ */ __name(function timeScale(value) {
    if (!arguments.length) {
...
var Timeline = function(_Animation) {
  ...
  _proto2.render = /* @__PURE__ */ __name(function render(totalTime, suppressEvents, force) {
  ...
  _proto2.invalidate = /* @__PURE__ */ __name(function invalidate() {
    var child = this._first;
    this._lock = 0;
    while (child) {
      child.invalidate();
...
var _addPropTween = /* @__PURE__ */ __name(function _addPropTween2(target, prop, start, end, index, targets, modifier, stringFilter, funcParam) {
...
var _initTween = /* @__PURE__ */ __name(function _initTween2(tween, time) {
...
var Tween = function(_Animation2) {
  ...
  _proto3.render = /* @__PURE__ */ __name(function render(totalTime, suppressEvents, force) {
  ...
  _proto3.invalidate = /* @__PURE__ */ __name(function invalidate() {
...
var _getBBoxHack = /* @__PURE__ */ __name(function _getBBoxHack2(swapIfPossible) {
...
var _addRotationalPropTween = /* @__PURE__ */ __name(function _addRotationalPropTween2(plugin, target, property, startNum, endValue, relative) {
