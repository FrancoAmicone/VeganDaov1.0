...
function _get(target, property, receiver) {
  if (typeof Reflect !== "undefined" && Reflect.get) {
    ...
    _get = /* @__PURE__ */ __name(function _get2(target2, property2, receiver2) {
...
var _default = function() {
  ...
  _createClass(_default2, [{
    ...
    key: "checkScroll",
    value: /* @__PURE__ */ __name(function checkScroll() {
      this.dispatchScroll();
    }, "checkScroll")
  }, {
    key: "checkResize",
    value: /* @__PURE__ */ __name(function checkResize() {
      var _this = this;
      if (!this.resizeTick) {
    ...
    key: "resize",
    value: /* @__PURE__ */ __name(function resize() {
    }, "resize")
  }, {
    key: "checkContext",
    value: /* @__PURE__ */ __name(function checkContext() {
    ...
    key: "initEvents",
    value: /* @__PURE__ */ __name(function initEvents() {
      var _this2 = this;
    ...
    key: "setScrollTo",
    value: /* @__PURE__ */ __name(function setScrollTo(event) {
    ...
    key: "addElements",
    value: /* @__PURE__ */ __name(function addElements() {
    }, "addElements")
  }, {
    key: "detectElements",
    value: /* @__PURE__ */ __name(function detectElements(hasCallEventSet) {
      var _this3 = this;
    ...
    key: "setInView",
    value: /* @__PURE__ */ __name(function setInView(current, i) {
    ...
    key: "setOutOfView",
    value: /* @__PURE__ */ __name(function setOutOfView(current, i) {
      var _this4 = this;
    ...
    key: "dispatchCall",
    value: /* @__PURE__ */ __name(function dispatchCall(current, way) {
      this.callWay = way;
    ...
    key: "dispatchScroll",
    value: /* @__PURE__ */ __name(function dispatchScroll() {
      var scrollEvent = new Event(this.namespace + "scroll");
      this.el.dispatchEvent(scrollEvent);
    }, "dispatchScroll")
  }, {
    key: "setEvents",
    value: /* @__PURE__ */ __name(function setEvents(event, func) {
    ...
    key: "unsetEvents",
    value: /* @__PURE__ */ __name(function unsetEvents(event, func) {
      if (!this.listeners[event])
        return;
      var list = this.listeners[event];
    ...
    key: "checkEvent",
    value: /* @__PURE__ */ __name(function checkEvent(event) {
      var _this5 = this;
    ...
    key: "startScroll",
    value: /* @__PURE__ */ __name(function startScroll() {
    }, "startScroll")
  }, {
    key: "stopScroll",
    value: /* @__PURE__ */ __name(function stopScroll() {
    }, "stopScroll")
  }, {
    key: "setScroll",
    value: /* @__PURE__ */ __name(function setScroll(x, y) {
...
var _default$1 = function(_Core) {
  ...
  _createClass(_default2, [{
    ...
    key: "addDirection",
    value: /* @__PURE__ */ __name(function addDirection() {
    ...
    key: "addSpeed",
    value: /* @__PURE__ */ __name(function addSpeed() {
      if (window.pageYOffset != this.instance.scroll.y) {
    ...
    key: "updateElements",
    value: /* @__PURE__ */ __name(function updateElements() {
      var _this4 = this;
      Object.entries(this.els).forEach(function(_ref) {
        var _ref2 = _slicedToArray(_ref, 2), i = _ref2[0], el = _ref2[1];
    ...
    value: /* @__PURE__ */ __name(function getRelativeOffset(offset) {
    ...
    key: "scrollTo",
    value: /* @__PURE__ */ __name(function scrollTo(target) {
      ...
      var isTargetReached = /* @__PURE__ */ __name(function isTargetReached2() {
...
var support = (/* @__PURE__ */ __name(function getSupport() {
  return {
...
var bindallStandalone = /* @__PURE__ */ __name(function(object) {
  if (!object)
...
var src$1 = /* @__PURE__ */ __name(function bezier(mX1, mY1, mX2, mY2) {
...
var _default$2 = function(_Core) {
  ...
  _createClass(_default2, [{
    ...
    key: "setScrollLimit",
    value: /* @__PURE__ */ __name(function setScrollLimit() {
    ...
    key: "startScrolling",
    value: /* @__PURE__ */ __name(function startScrolling() {
    ...
    key: "stopScrolling",
    value: /* @__PURE__ */ __name(function stopScrolling() {
    ...
    key: "checkKey",
    value: /* @__PURE__ */ __name(function checkKey(e) {
      var _this3 = this;
      if (this.stop) {
    ...
    value: /* @__PURE__ */ __name(function isActiveElementScrollSensitive() {
    ...
    key: "updateDelta",
    value: /* @__PURE__ */ __name(function updateDelta(e) {
      var delta;
    ...
    key: "updateScroll",
    value: /* @__PURE__ */ __name(function updateScroll(e) {
    ...
    key: "initScrollBar",
    value: /* @__PURE__ */ __name(function initScrollBar() {
    ...
    key: "reinitScrollBar",
    value: /* @__PURE__ */ __name(function reinitScrollBar() {
      this.hasScrollbar = false;
      if (this.direction == "horizontal") {
        if (this.instance.limit.x + this.windowWidth <= this.windowWidth) {
          return;
    ...
    value: /* @__PURE__ */ __name(function destroyScrollBar() {
    ...
    key: "getScrollBar",
    value: /* @__PURE__ */ __name(function getScrollBar(e) {
    ...
    value: /* @__PURE__ */ __name(function releaseScrollBar(e) {
    ...
    key: "moveScrollBar",
    value: /* @__PURE__ */ __name(function moveScrollBar(e) {
      var _this5 = this;
    ...
    key: "addSections",
    value: /* @__PURE__ */ __name(function addSections() {
      var _this7 = this;
      this.sections = {};
    ...
    key: "transform",
    value: /* @__PURE__ */ __name(function transform(element, x, y, delay) {
      var transform2;
      if (!delay) {
    ...
    value: /* @__PURE__ */ __name(function transformElements(isForced) {
      var _this8 = this;
    ...
    value: /* @__PURE__ */ __name(function scrollTo(target) {
      ...
      var render = /* @__PURE__ */ __name(function render2(p) {
        if (disableLerp) {
...
var Smooth = function() {
  ...
  _createClass(Smooth2, [{
    ...
    key: "scrollTo",
    value: /* @__PURE__ */ __name(function scrollTo(target, options) {
    ...
    key: "on",
    value: /* @__PURE__ */ __name(function on(event, func) {
      this.scroll.setEvents(event, func);
    }, "on")
  }, {
    key: "off",
    value: /* @__PURE__ */ __name(function off(event, func) {
